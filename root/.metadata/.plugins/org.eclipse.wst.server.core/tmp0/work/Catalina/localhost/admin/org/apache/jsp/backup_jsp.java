 ...
 * Generated at: 2024-02-24 07:14:13 UTC
...
public final class backup_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  String strName = (String) request.getAttribute("name");
      ...
      out.write("\t<h2>バックアップ</h2>\r\n");
      out.write("\r\n");
      out.write("\t面談情報のデータをバックアップします。<br>\r\n");
      out.write("\t注意！<br>\r\n");
      out.write("\tバックアップは１日に１度のみ実施可能です。２度目のバックアップは失敗します。<br>\r\n");
      out.write("\t<form id=\"fm\" action=\"/admin/BackupController\" method=\"Post\">\r\n");
      out.write("    \t<button class=\"btn btn-primary\" name=\"check\" value=\"backup\" onclick=\"exec()\">データバックアップ</button>\r\n");
      out.write("\t</form>\r\n");
      out.write("\r\n");
      out.write("    <form id=\"fm\" action=\"/admin/BackupController\" method=\"Get\">\r\n");
      out.write("\t    ");
 if (null != request.getAttribute("err")) { 
      ...
      out.write("\r\n");
      out.write("<script>\r\n");
      out.write("    function backup(button) {\r\n");
      out.write("        var form = document.getElementById(\"fm\");\r\n");
      out.write("        form.action = \"/admin/BackupController\"; // サーブレットのURLを指定\r\n");
